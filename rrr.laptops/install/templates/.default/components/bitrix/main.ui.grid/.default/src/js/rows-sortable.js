;(function () {
    ...
    BX.Grid.RowDragEvent.prototype = {
        ...
        allowInsertBefore: function () {
            this.allowInsertBeforeTarget = true;
        },
        disallowMove: function (errorMessage) {
            this.allowMoveRow = false;
            this.errorMessage = errorMessage || '';
        },
        disallowInsertBefore: function () {
        ...
        isAllowedMove: function () {
            return this.allowMoveRow;
        },
        isAllowedInsertBefore: function () {
